...
export default function ServiceCard({
    ...
    <div className="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-8 dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="flex items-baseline text-gray-900 dark:text-white">
        ...
        <span className="text-4xl font-extrabold tracking-tight">{one_time_price}</span>
      ...
      {<a href='/details' className="pb-5 inline-flex justify-left font-medium text-rose-500 dark:text-rose-500 hover:underline">More Details</a>}
