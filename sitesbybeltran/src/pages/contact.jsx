          ...
          <div className="mx-auto mt-16 max-w-xl sm:mt-20">
            ...
            <div className="mt-10">
              <button 
                ...
                className="block w-full rounded-md bg-rose-700 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-rose-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                Let's talk
              </button>
            </div>
